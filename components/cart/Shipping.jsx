        ...
        <section className="py-10 bg-gray-50">
            ...
            <div className="flex flex-col md:flex-row gap-4 lg:gap-8">
                ...
                <article className="text-gray-600" style={{ maxWidth: "350px" }}>
                    ...
                    <li className="flex justify-between mb-1">
                        <span>Est TAX:</span>
                        <span>{cart?.checkoutInfo?.tax.toFixed(0)}.000 VNĐ</span>
                    </li>
                    <li className="border-t flex justify-between mt-3 pt-3">
                        <span>Total Amount:</span>
                        <span className="text-gray-900 font-bold">{cart?.checkoutInfo?.totalAmount.toFixed(0)}.000 VNĐ</span>
                    </li>
                    </ul>
                    ...
                    {cart?.cartItems?.map((item) => (
                        ...
                        <figcaption class="ml-3">
                            ...
                            <p class="mt-1 text-gray-400">Total: {item.quantity * item.price}.000 VNĐ</p>
                        </figcaption>
                        </figure>
                    ))}
